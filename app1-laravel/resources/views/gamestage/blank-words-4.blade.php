...
<div class="image-container">
    ...
    <div class="text-answer text-answer1" id="answer1" draggable="true" ondragstart="drag(event)">Abdi</div>
    ...
    <div class="text-answer text-answer4" id="answer4" draggable="true" ondragstart="drag(event)">Wolf</div>
</div>
