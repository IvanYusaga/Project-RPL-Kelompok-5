...
<div class="image-container">
    ...
    <div class="text-answer text-answer1" id="answer1" draggable="true" ondragstart="drag(event)">Ipan</div>
    <div class="text-answer text-answer2" id="answer2" draggable="true" ondragstart="drag(event)">Look</div>
    <div class="text-answer text-answer3" id="answer3" draggable="true" ondragstart="drag(event)">Like</div>
    <div class="text-answer text-answer4" id="answer4" draggable="true" ondragstart="drag(event)">Donkey</div>
</div>
